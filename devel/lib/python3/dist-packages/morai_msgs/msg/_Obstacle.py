...
"""autogenerated by genpy from morai_msgs/Obstacle.msg. Do not edit."""
import codecs
import sys
...
class Obstacle(genpy.Message):
  _md5sum = "3348e0542b062f48f34bb1828ddeaeec"
  _type = "morai_msgs/Obstacle"
...
float64 w
"""
  __slots__ = ['header','pose','map_name','width','depth','height']
  _slot_types = ['std_msgs/Header','geometry_msgs/Pose','string','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose,map_name,width,depth,height
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3f().pack(_x.width, _x.depth, _x.height))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.width, _x.depth, _x.height,) = _get_struct_3f().unpack(str[start:end])
      return self
