...
(cl:defmethod cl:initialize-instance :after ((m <Obstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morai_msgs-msg:<Obstacle> is deprecated: use morai_msgs-msg:Obstacle instead.")))
...
(cl:defmethod pose-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:pose-val is deprecated.  Use morai_msgs-msg:pose instead.")
  (pose m))

(cl:ensure-generic-function 'map_name-val :lambda-list '(m))
(cl:defmethod map_name-val ((m <Obstacle>))
...
(cl:defmethod depth-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:depth-val is deprecated.  Use morai_msgs-msg:depth instead.")
  (depth m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Obstacle>)))
  ...
  "3348e0542b062f48f34bb1828ddeaeec")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Obstacle)))
  "Returns md5sum for a message object of type 'Obstacle"
  "3348e0542b062f48f34bb1828ddeaeec")
