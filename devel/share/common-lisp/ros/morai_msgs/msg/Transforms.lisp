...
(cl:defmethod cl:initialize-instance :after ((m <Transforms>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Transforms)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morai_msgs-msg:<Transforms> is deprecated: use morai_msgs-msg:Transforms instead.")))

(cl:ensure-generic-function 'transforms-val :lambda-list '(m))
(cl:defmethod transforms-val ((m <Transforms>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morai_msgs-msg:transforms-val is deprecated.  Use morai_msgs-msg:transforms instead.")
  (transforms m))
